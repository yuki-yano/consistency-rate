...
export const cardsAtom = atomWithHash<CardsState>("cards", defaultCardsState, createUrlSerializeOptions(defaultCardsState))

export const patternAtom = atomWithHash<PatternState>("pattern", defaultPatternState, createUrlSerializeOptions(defaultPatternState))

export const labelAtom = atomWithHash<LabelState>("label", defaultLabelState, createUrlSerializeOptions(defaultLabelState))
...
export const aiProviderAtom = atom<"google" | "openai">("google")
